...
with open('dataanalysis/commuteblrmetroprop.geojson') as f:
    data = json.load(f)
...
for pointA in categoryA:
    ...
    scatter_size.append(15 + min_distance * 0.008)  # Adjust the scaling for size
...
fig.update_layout(
    mapbox=dict(
        ...
        center=dict(lat=12.97, lon=77.61),
        zoom=11,
